...
import com.f.datasource.core.DynamicDataSourceTransactionFactory;
...
public class MybatisAutoConfigurer {
    ...
    public MybatisAutoConfigurer(MybatisProperties properties,
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        factory.setTransactionFactory(new DynamicDataSourceTransactionFactory());
